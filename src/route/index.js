...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        {
          name: 'Zaporizhia Electrotechnical College of the National University',
          isEnd: true,
        },
        {
          ...
          projects: [
            {
              ...
              about:
                'Airbnb comprtitor. High-load application for seaching apartments',
              stacks: [
                {
                  name: 'React.js',
                },
...
router.get('/bootstrap-old', function (req, res) {
  // res.render генерує нам HTML сторінку

  //            ↙ cюди вводимо назву файлу з сontainer
  res.render('bootstrap-old', {
    layout: 'bootstrap',
  })
  //                  ↑↑ сюди вводимо JSON дані
})
